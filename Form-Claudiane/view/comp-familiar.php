...
<head>
    ...
    <title>COMPOSIÇÃO FAMILIAR</title>
    ...
    <main class="abas home" id="ficha-bio">
        ...
        <div class="container-flex m-3 mx-4 " >
            ...
            <div class="container-fluid py-5">
                ...
                <h4 class="display-6 my-icon"><i class='bx bx-group px-2'></i>COMPOSIÇÃO FAMILIAR</h4>
                </div>

                <form class="row g-3">
            <div class="col-md-8 position-relative">
            <label for="validationTooltip01" class="form-label">Nome completo do familiar:</label>
            ...
            <div class="col-md-6 position-relative">
            <label for="validationTooltipUsername" class="form-label">Escolaridade:</label>
                <select id="inputState" style="background-color: #F6F5FF;"  class="form-select">
                <option selected>Por favor selecione...</option>
                <option>Desempregado</option>
                <option>Autônomo</option>
            ...
            <label for="validationTooltip05" class="form-label">Profissão:</label>
                ...
                <div class="invalid-tooltip">
                Por favor escolha um Profissão valído
                </div>
            </div>

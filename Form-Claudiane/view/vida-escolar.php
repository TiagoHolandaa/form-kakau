...
<body>
    ...
    <main class="abas home" id="ficha-bio">
        ...
        <div class="container-flex m-3 mx-4 " >
            ...
            <div class="p-5 pt-2 mb-4 bg-white rounded-3">
            <div class="container-fluid py-5">
                ...
                <h4 class="display-6 my-icon"><i class='bx bx-book px-2'></i>VIDA ESCOLAR</h4>
                </div>

                <form class="row gx-3 gy-2 align-items-center">
                    <div class="col-5">
                        <select class="form-select" aria-label="Default select example">
                            <option selected>Selecione um por favor</option>
                            <option value="1">Portugês</option>
                            <option value="2">Matemática</option>
                            <option value="3">Geografia</option>
                            <option value="1">História</option>
                            <option value="2">Biologia</option>
                            <option value="3">Química</option>
                            <option value="1">Filosifia</option>
                    ...
                    <div class="form-check form-switch">
                        ...
                        <label class="form-check-label" for="flexSwitchCheckDefault">Recebeu apoio pedagógico extra-aula</label>
                    </div>
                    </div>
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault">
                        <label class="form-check-label" for="flexSwitchCheckDefault">É uma das disciplinas preferidas</label>
                    </div>
                    </div>
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault">
                        <label class="form-check-label" for="flexSwitchCheckDefault">Possui mais dificuldade</label>
                    </div>
                    </div>
        ...
        <div class="container-flex mx-3 p-1 px-5 bg-white rounded-3">
            <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                <div class="col-md-4 d-flex align-items-center">
                <a href="/" class="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
                    <img src="../img/logo-sNome.png" alt="" width="35px">
                </a>
